package mx.fiscoflex.service.venta;
...
import mx.fiscoflex.model.Concepto;
import mx.fiscoflex.repository.ConceptoRepositoryImpl;
import mx.fiscoflex.service.venta.ConceptoDTO;
...
public class ConceptoEJB {
	...
	@Inject
	ConceptoRepositoryImpl conceptoQuery;
	...
	public ConceptoDTO obtenerConcepto(Integer id) {
		...
		try {
			utx.begin();
			Concepto conceptoEntity = conceptoQuery.obtenerConceptoPorId(id);
	...
	public List<ConceptoDTO> listaConcepto() {
		...
		try {
			utx.begin();
			List<Concepto> listaConceptoEntities = conceptoQuery.obtenerListaConcepto();
			for (Concepto concepto : listaConceptoEntities) {
				ConceptoDTO conceptoDTO = new ConceptoDTO();
