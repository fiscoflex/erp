package mx.fiscoflex.service.usuario;
...
import mx.fiscoflex.repository.UsuarioRepositoryImpl;
...
public class UsuarioService {
	...
	@Inject
	UsuarioRepositoryImpl usuarioQuery;
	...
	public UsuarioDTO obtenerUsuario(String nombre) {
		...
		try {
			userTransaction.begin();
			Usuario usuarioEntity = usuarioQuery.consultarUsuarioPorNombre(nombre);
	...
	public List<UsuarioDTO> listaUsuarios() {
		...
		try {
			utx.begin();
			List<Usuario> listaUsuarioEntities = usuarioQuery.obtenerUsuarios();
			for (Usuario usuario : listaUsuarioEntities) {
				UsuarioDTO usuarioDTO = new UsuarioDTO();
